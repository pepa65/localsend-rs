...
impl ApiRoute {
	...
	fn route(&self, version: impl AsRef<str>) -> String {
		let path = if version.as_ref() == PROTOCOL_VERSION_1 { format!("/v1/{}", self._v1()) } else { format!("/v2/{}", self._v2()) };
	...
	pub fn target_raw(&self, ip: impl AsRef<str>, port: u16, https: bool, version: impl AsRef<str>) -> String {
